...
let test_Z() =
  ...
  Printf.printf "1      (odd,even)=(%b,%b)\n" (I.is_odd I.one) (I.is_even I.one);
  Printf.printf "-1     (odd,even)=(%b,%b)\n" (I.is_odd I.minus_one) (I.is_even I.minus_one);
  Printf.printf "min_int(odd,even)=(%b,%b)\n" (I.is_odd mini) (I.is_even mini);
  Printf.printf "2^120  (odd,even)=(%b,%b)\n" (I.is_odd p120)  (I.is_even p120);
  Printf.printf "1[0<-0] = %a\n" pr (I.clrbit I.one 0);
  Printf.printf "1[1<-1] = %a\n" pr (I.setbit I.one 1);
  Printf.printf "1[~<-0] = %a\n" pr (I.combit I.one 0);
  Printf.printf "1[~<-1] = %a\n" pr (I.combit I.one 1);
  Printf.printf "-1[120<-0] = %a\n" pr (I.clrbit I.minus_one 120);
  Printf.printf " 1[120<-1] =  %a\n" pr (I.setbit I.one 120);
  Printf.printf "-1[~<-120] = %a\n" pr (I.combit I.minus_one 120);
  Printf.printf " 1[~<-120] =  %a\n" pr (I.combit I.one 120);
  Printf.printf "ffs 2^120  = %i\n" (I.findfirstset p120);
  Printf.printf "ffs -2^120 = %i\n" (I.findfirstset (I.neg p120));
  Printf.printf "ffs 1 = %i\n" (I.findfirstset I.one);
  Printf.printf "fls 2^120 = %i\n" (I.findlastset p120);
  Printf.printf "fls 1 = %i\n" (I.findlastset I.one);
  Printf.printf "sizeinbase 2^120 10 = %i\n" (I.sizeinbase p120 10);
  Printf.printf "sizeinbase 1 10 = %i\n" (I.sizeinbase I.one 10);
